...
data_files = [data_file for data_file in data_files if ((not ("Templates" in data_file)) and "RegCon" in data_file and "nom" in data_file)]
template_files = []
...
save_name = "pkls/hists_selection_control_TH.pkl" 
root_save_name = "All_selection_control.root" 
